import{Kw as be,Ks as we,KO as Ve,Iw as f,JI as w,KB as De,Ix as B,It as r,c2 as z,x$ as ee,Kv as xe,Jm as E,cU as te,cS as A,hk as F,KP as Le,hM as ie,JG as ne,I_ as S,g0 as _,cR as v,KQ as se,Aj as ae,n as o,mS as re,hj as ye,s1 as Ee,cV as Se,d4 as le,fb as oe,hh as Ce,Kt as Me,yd as Ae,IY as $e,JQ as Re,Is as H,g2 as Te,r1 as ce,r3 as he,_ as de,g3 as Ie,g6 as K,qA as j,ak as c,an as q,jR as pe,g4 as ue,cP as Oe,cT as O,lH as Ue,J9 as je,lJ as ze,KR as qe,II as D,oi as Ne,oj as G,KS as We,mQ as Be,KT as $,KU as Fe,x2 as J,rZ as He,vK as Ke,r_ as Ge,r$ as Je,s0 as ke,s2 as Qe,am as C,KV as Xe,o0 as k}from"./index-Ce5MCOsz.js";import{t as Ze}from"./VisualElement-CfVg0LqO.js";function fe(t,e){const n=t.fragment;n.include(be),t.include(we),n.include(Ve),n.uniforms.add(new f("globalAlpha",i=>i.globalAlpha),new w("glowColor",i=>i.glowColor),new f("glowWidth",(i,s)=>i.glowWidth*s.camera.pixelRatio),new f("glowFalloff",i=>i.glowFalloff),new w("innerColor",i=>i.innerColor),new f("innerWidth",(i,s)=>i.innerWidth*s.camera.pixelRatio),new De("depthMap",i=>i.depth?.attachment),new B("normalMap",i=>i.normals)),n.code.add(r`vec4 premultipliedColor(vec3 rgb, float alpha) {
...
return abs(dist);
}`),t.spherical){const i=(a,l,p)=>_(a,l.heightManifoldTarget,p.camera.viewMatrix),s=(a,l)=>_(a,[0,0,0],l.camera.viewMatrix);n.uniforms.add(new E("heightManifoldOrigin",(a,l)=>(i(u,a,l),s(V,l),te(V,V,u),A(d,V),d[3]=F(V),d)),new Le("globalOrigin",a=>s(u,a)),new f("cosSphericalAngleThreshold",(a,l)=>1-Math.max(2,ie(l.camera.eye,a.heightManifoldTarget)*l.camera.perRenderPixelRatio)/F(a.heightManifoldTarget))),n.code.add(r`float globeDistancePixels(float posInGlobalOriginLength) {
