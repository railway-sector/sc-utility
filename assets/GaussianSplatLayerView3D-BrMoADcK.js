...
}`)}let Ci=class extends Te{constructor(){super(...arguments),this.tileCameraPosition=H(),this.cameraDelta=H()}};function Ti(i){i.code.add(_`vec4 unpackColor(uvec4 packedGaussian) {
vec4 color;
