import{JD as Pe,Jz as be,K2 as we,Hx as f,IO as w,JF as De,Hy as W,Hu as r,fp as z,x6 as Y,JC as Ve,Ir as C,g8 as ee,g9 as R,hR as F,K3 as xe,fS as te,IM as ie,I4 as M,gP as m,g$ as v,K4 as ne,zq as se,K as o,mF as ae,hQ as Ee,i9 as ye,ga as Le,dz as re,fY as le,hO as Se,JA as Ce,xk as Me,I2 as Ae,IW as $e,Ht as B,gR as Re,HA as oe,HB as ce,_ as he,pe as Te,g_ as G,ia as q,ag as c,al as j,jZ as de,jX as pe,dE as Ie,dy as I,lr as Oe,Id as qe,lw as Ue,K5 as ze,HP as V,JJ as je,JK as K,K6 as Ne,mD as He,K7 as T,K8 as We,i4 as Fe,v8 as Be,i6 as Ge,i7 as Ke,i8 as Je,ib as ke,ah as A,K9 as Xe,pN as J}from"./index-CWtlh_JD.js";import{t as Qe}from"./VisualElement-CB2jfZJd.js";function ue(t,e){const n=t.fragment;n.include(Pe),t.include(be),n.include(we),n.uniforms.add(new f("globalAlpha",i=>i.globalAlpha),new w("glowColor",i=>i.glowColor),new f("glowWidth",(i,s)=>i.glowWidth*s.camera.pixelRatio),new f("glowFalloff",i=>i.glowFalloff),new w("innerColor",i=>i.innerColor),new f("innerWidth",(i,s)=>i.innerWidth*s.camera.pixelRatio),new De("depthMap",i=>i.depth?.attachment),new W("normalMap",i=>i.normals)),n.code.add(r`vec4 premultipliedColor(vec3 rgb, float alpha) {
...
}`)}const N=z(6);function fe(t){const e=new Y;e.include(Ve),e.include(ue,t);const n=e.fragment;if(t.lineVerticalPlaneEnabled||t.heightManifoldEnabled)if(n.uniforms.add(new f("maxPixelDistance",(i,s)=>t.heightManifoldEnabled?2*s.camera.computeScreenPixelSizeAt(i.heightManifoldTarget):2*s.camera.computeScreenPixelSizeAt(i.lineVerticalPlaneSegment.origin))),n.code.add(r`float planeDistancePixels(vec4 plane, vec3 pos) {
float dist = dot(plane.xyz, pos) + plane.w;
float width = fwidth(dist);
dist /= min(width, maxPixelDistance);
return abs(dist);
}`),t.spherical){const i=(a,l,p)=>m(a,l.heightManifoldTarget,p.camera.viewMatrix),s=(a,l)=>m(a,[0,0,0],l.camera.viewMatrix);n.uniforms.add(new C("heightManifoldOrigin",(a,l)=>(i(u,a,l),s(D,l),ee(D,D,u),R(d,D),d[3]=F(D),d)),new xe("globalOrigin",a=>s(u,a)),new f("cosSphericalAngleThreshold",(a,l)=>1-Math.max(2,te(l.camera.eye,a.heightManifoldTarget)*l.camera.perRenderPixelRatio)/F(a.heightManifoldTarget))),n.code.add(r`float globeDistancePixels(float posInGlobalOriginLength) {
