import{x6 as ee,IU as te,IV as ie,Hr as re,Hp as ae,IW as se,IX as oe,Hu as o,IN as ne,I2 as ce,IM as le,Ht as _,IY as pe,IZ as de,I6 as N,Hs as he,Hv as ve,Hw as ue,Ir as me,Hy as fe,I_ as j,I$ as E,J0 as ge,J1 as Se,I7 as Pe,jX as ye,HA as we,jZ as _e,HB as ze,_ as xe,HC as M,HD as R,HE as $e,HF as U,HG as L,I9 as be,HI as Te,HJ as Ve,HK as ke,HM as V,HN as Oe,J2 as De,J3 as J,J4 as B,J5 as We,J6 as Ce,J7 as Me,ag as c,al as Le,HO as Ie,HP as d,gv as He,Ia as Ae,J8 as q,rK as Fe,ID as Ne,J9 as je,HS as Ee,dy as K,l1 as Re,gP as Y,K as G,Ja as Ue}from"./index-B4GEcG7G.js";function X(t){const e=new ee,{space:r,anchor:i,hasTip:P,hasScreenSizePerspective:z}=t,u=r===2,g=r===1;e.include(te,t),e.include(ie,t),e.include(re,t);const{vertex:a,fragment:S,varyings:y}=e;ae(a,t),e.attributes.add("position","vec3"),e.attributes.add("previousDelta","vec4"),e.attributes.add("uv0","vec2"),y.add("vColor","vec4"),y.add("vpos","vec3",{invariant:!0}),y.add("vUV","vec2"),y.add("vSize","float"),P&&y.add("vLineWidth","float"),a.uniforms.add(new se("nearFar",({camera:p})=>p.nearFar),new oe("viewport",({camera:p})=>p.fullViewport)).code.add(o`vec4 projectAndScale(vec4 pos) {
