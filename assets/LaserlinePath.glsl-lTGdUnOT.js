import{JD as Pe,Jz as be,K2 as we,Hx as f,IO as w,JF as De,Hy as W,Hu as r,f3 as j,x6 as Y,JC as Ve,Ir as C,fO as ee,fP as R,hv as F,K3 as xe,fw as te,IM as ie,I4 as M,gt as m,gF as v,K4 as ne,zq as se,o,mF as ae,hu as Ee,hP as ye,fQ as Le,dc as re,fC as le,hs as Se,JA as Ce,xk as Me,I2 as Ae,IW as $e,Ht as B,gv as Re,HA as oe,HB as ce,_ as he,pe as Te,gE as G,hQ as q,av as c,ay as z,jZ as de,jX as pe,dh as Oe,db as O,lr as Ie,Id as qe,lw as Ue,K5 as je,HP as V,JJ as ze,JK as K,K6 as Ne,mD as He,K7 as T,K8 as We,hK as Fe,v8 as Be,hM as Ge,hN as Ke,hO as Je,hR as ke,ax as A,K9 as Qe,pN as J}from"./index-DZEz3PPM.js";import{t as Xe}from"./VisualElement-Bpf2GWeX.js";function ue(t,e){const n=t.fragment;n.include(Pe),t.include(be),n.include(we),n.uniforms.add(new f("globalAlpha",i=>i.globalAlpha),new w("glowColor",i=>i.glowColor),new f("glowWidth",(i,s)=>i.glowWidth*s.camera.pixelRatio),new f("glowFalloff",i=>i.glowFalloff),new w("innerColor",i=>i.innerColor),new f("innerWidth",(i,s)=>i.innerWidth*s.camera.pixelRatio),new De("depthMap",i=>i.depth?.attachment),new W("normalMap",i=>i.normals)),n.code.add(r`vec4 premultipliedColor(vec3 rgb, float alpha) {
